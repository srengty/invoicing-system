        ...
        <div class="p-6 text-sm">
            ...
            <div class="pl-2 pr-6">
                ...
                <div
                    class="total-container mt-4 flex justify-between items-center"
                >
                    <label for="deposit_amount" class="font-bold"
                        >Deposit Total:</label
                    >
                    <p class="font-bold text-right">
                ...
                <div
                    class="total-container mt-4 flex justify-between items-center"
                >
                    <label for="installment_paid" class="font-bold"
                        >Final Total:</label
                    >
                    <p class="font-bold text-right">
...
const submitInvoice = async () => {
    ...
    form.grand_total = productsList.value.reduce(
    ...
    form.total_usd =
        ...
        (form.exchange_rate > 0
            ? (form.grand_total / form.exchange_rate).toFixed(2)
            : 0);
    form.exchange_rate =
        form.exchange_rate ||
        (form.total_usd > 0
            ? (form.grand_total / form.total_usd).toFixed(2)
            : 0);
