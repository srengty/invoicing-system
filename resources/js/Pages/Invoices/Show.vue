    ...
    <GuestLayout>
        ...
        <div class="create-invoice text-sm">
            ...
            <form @submit.prevent="submitInvoice">
                <div
                    class="p-3 grid grid-cols-1 md:grid-cols-3 gap-4 ml-4 mr-4 text-sm"
                >
                    <div>
                    ...
                    <div class="">
                        <div class="">
                            <label for="deposit_no" class="block font-medium"
...
const { products, agreements, quotations, customers, product_quotations } =
    usePage().props;
